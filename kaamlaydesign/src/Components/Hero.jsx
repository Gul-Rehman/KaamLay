...
const Hero = () => {
  ...
  return (
    ...
    <Box  sx={{
      ...
      backgroundColor:{laptopl:"whitesmoke",laptops:"whitesmoke",tablet:"whitesmoke",xs:"#fa541c"}
    }}>
      <Stack direction="row" spacing={14}  sx={{pt:{laptops:"100px",tablet:"50px"}}}> 
      {/* sx={{ pt:{laptopl:"100px", laptops:"100px"}  }} */}
        <Stack sx={{pt:"40px", pl:"60px"}}>
      <Typography  fontFamily="DenseLetters"  color="white"  fontSize={{laptopl:"65px",laptops:"45px",tablet:"30px",mobilel:"30px"} } letterSpacing={5} sx={{}}> Kaam Lena Hai<span style={{fontFamily : "Roboto, Arial, Tahoma, Serif"}}>?</span> </Typography>
      {/* <Typography fontSize={{lg:"78px",md:"70px",xs:"50px"} } display="inline" color="white"> ? </Typography> */}
      <Typography fontSize={{laptopl:"40px",laptops:"25px",tablet:"17px"} } letterSpacing={2} >Don't Worry Kaam Lay Se Kaam Lo</Typography>
      <Stack direction="row" sx={{marginLeft:"-20px",mt:"auto"}}>
      <CustomizedButton onClick={opensignup}>
      ...
      <img src={ServiceIllustration} alt='Service Illustration' style={{width:"500px", position:"absolute", right:"70px"}}/>
      </Stack>
      <Stack sx={{display:{
          xs:"none",
          laptops:"flex",
      ...
      <img src={ServiceIllustration} alt='Service Illustration' style={{width:"400px", position:"absolute", right:"70px"}}/>
      </Stack>
      <Stack sx={{display:{
          xs:"none",
          laptops:"none",
      ...
      <img src={ServiceIllustration} alt='Service Illustration' style={{width:"250px", position:"absolute", right:"70px"}}/>
      </Stack>
      </Stack>
      </Stack>
      </Box>
