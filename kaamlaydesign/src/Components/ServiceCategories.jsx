          ...
          >
            ...
            <CardContent sx={{}}>
              ...
              <Typography variant="body2" color="text.secondary">
                Plumbers install and repair pipes and fixtures that carry water,
                gas, or other fluids in homes
              </Typography>
            </CardContent>
          </CardActionArea>
          <CardActions sx={{}}>
        ...
        <CustomizedCard sx={{}}>
          ...
          >
            ...
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary">
                Technician will service and clean the system and change the air
                conditioning filter. Cleaning and changing out the air filter.
              </Typography>
            </CardContent>
          </CardActionArea>
          <CardActions>
